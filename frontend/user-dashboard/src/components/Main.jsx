      ...
      {routineCtx.routine ? (
        taskId ? (
          <div
            className={classNames(
              'text-white flex flex-col  overflow-scroll scrollbar-thin scrollbar-thumb-secondary scrollbar-track-primary',
              className
            )}
          >
            ...
            {selectedTask?.isCompleted &&<div className="flex-1 ">
            ...
            <div className="flex-1  ">
              {enableTimer ? (
                ...
                <div className="flex-1 flex flex-col item-center justify-center my-1 bg-secondary text-primary rounded-md mx-96 p-5">
        ...
        <div className={classNames(className, 'h-full flex justify-center items-center')}>
          <div className="flex flex-col items-center ">
            ...
            <button
              className="mt-1 p-1 bg-app-blue rounded-lg text-secondary font-semibold text-sm animate-pulse animate-infinite"
